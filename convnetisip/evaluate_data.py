...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str,default=r'C:\Users\Azhang6\Downloads\TFrec\data_test',
                        help='path to the recrords to evaluate')
    parser.add_argument('--checkpoint_dir',default='output\checkpoints\ConvNetISIP',
    ...
    parser.add_argument('--events', action='store_true',default = True,
